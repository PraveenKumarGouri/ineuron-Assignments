...
data = {
    "name" : "praveen",
    "mail_id" : "praveen39.39.39@gamil.com",
...
list_of_records=[
    {
        ...
        'course_offered' : "Machine Learning with Deployemenmt"},
    {
        'companyname' : 'iNeuron',
        'product' : 'Affordable AI',
        'course_offered' : "Deeplearning for NLP Computer Vision"},
    {
        'companyname' : 'iNeuron',
        'product' : 'Affordable AI',
        'course_offered' : "Data Science masters program"}
]
...
data= collection.find({"course_offered" : {"$gt" : "E"}})
for i in data :
    print(i)
